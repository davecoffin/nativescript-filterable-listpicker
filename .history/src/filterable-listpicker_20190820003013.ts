                      ...
                      <ListView.itemTemplate>
                          <StackLayout class="flp-row">
                              <GridLayout columns="auto, *, auto" visibility="{{title ? 'visible' : 'collapsed'}}" class="flp-row-container">
                                  <Image src="{{cache.placeholder ? cache.placeholder : 'http://icons.iconarchive.com/icons/aha-soft/desktop-halloween/256/Hat-icon.png'}}" width="30" visibility="{{image ? 'visible' : 'collapsed'}}" stretch="aspectFit" rowSpan="2" class="flp-image"></Image>
