...
let placeholder = fromFile("./assets/download.png");
let t = "frfrfrfr";
cache.maxRequests = 5;
                      ...
                      <ListView.itemTemplate>
                          <StackLayout class="flp-row">
                              <GridLayout columns="auto, *, auto" visibility="{{title ? 'visible' : 'collapsed'}}" class="flp-row-container">
                                  <Image src="{{placeholder ? placeholder : 'http://icons.iconarchive.com/icons/aha-soft/desktop-halloween/256/Hat-icon.png'}}" width="30" visibility="{{image ? 'visible' : 'collapsed'}}" stretch="aspectFit" rowSpan="2" class="flp-image"></Image>
                                  <StackLayout class="flp-title-container" col="1" verticalAlignment="middle">
                                      <Label text="{{t}}" textWrap="true" class="flp-title"></Label>
